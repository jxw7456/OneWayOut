...
namespace OneWayOut.Scenes
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            /*This lets the user go from one screen to any screen they want, which we do not want.
            ...
            */
            ...
            switch (game.state)
            {
                ...
                case GameState.START:
                    ...
                    if (SingleKeyPress(Keys.Enter) || SingleKeyPress(Keys.F3))
                    {
                ...
                case GameState.GAME:
                    ...
                    if (SingleKeyPress(Keys.F6))
                    {
                        game.state = GameState.PAUSE;
                    }

                    if (SingleKeyPress(Keys.F5) || player.health <= 0)
                    {
